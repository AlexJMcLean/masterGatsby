let path,resolve,fetch;_1ae‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_1ae‍.w("path",[["default",["path"],function(v){path=v}],["resolve",["resolve"],function(v){resolve=v}]]);_1ae‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnSlicemastersIntoPages({ graphql, actions}) {
  ...
  Array.from({ length: numOfPages }).forEach((_,i) => {
    actions.createPage({
      ...
      component: path.resolve('./src/pages/slicemasters'),
      context: {
        skip: i * pageSize,
        currentPage: i + 1,
        pageSize
